...
function About() {
  return (
    <section className="page about-page" id="about" aria-labelledby="about-heading">
      <div className="page-container">
        ...
        {/* Section Heading */}
        <h1 className="page-heading" id="about-heading">
        ...
        <div className="about-grid">
          ...
          <article className="about-text">
            ...
            <div className="about-stats" role="list">
              <div className="about-stat-item" role="listitem">
          ...
          {/* Key Identifiers / Information Cards */}
          <aside className="about-info-cards" role="list">
